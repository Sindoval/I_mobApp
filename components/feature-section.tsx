        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
          <Card>
            <CardHeader className="pb-2">
              <Building className="h-6 w-6 text-teal-600 dark:text-teal-400 mb-2" />
          ...
          <Card>
            <CardHeader className="pb-2">
              <FileText className="h-6 w-6 text-teal-600 dark:text-teal-400 mb-2" />
          ...
          <Card>
            <CardHeader className="pb-2">
              <Camera className="h-6 w-6 text-teal-600 dark:text-teal-400 mb-2" />
          ...
          <Card>
            <CardHeader className="pb-2">
              <Shield className="h-6 w-6 text-teal-600 dark:text-teal-400 mb-2" />
